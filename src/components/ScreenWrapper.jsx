    ...
    <View style={styles.container}>
      ...
      <Svg width="100%" height="100%" style={StyleSheet.absoluteFill}>
        <Defs>
          ...
          <RadialGradient id="topRightGlow" cx="0.8" cy="0.15" r="0.85">
          ...
          <RadialGradient id="midRightGlow" cx="1.0" cy="0.65" r="0.75">
          ...
          <RadialGradient id="bottomLeftGlow" cx="0.15" cy="0.85" r="0.85">
